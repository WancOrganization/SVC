        ...
        <div class="row m-b-40">
            <div class="sidebar sticky-sidebar col-lg-5">
                <div class="heading-text text-white text-left heading-section">
                    <h2>Puzzle Parking</h2>
                </div>
                <div class="project-description text-white">
                    <h3>The Puzzle-Parking System, also referred to as the Lift-Slide System, is probably the most popular among other Self-Parking Systems and one of the most commonly use system in India</h3>
                </div>

                <ul class="list-icon list-icon-arrow text-white">
                    <li>Suitable for outdoor installations in open spaces.</li>
                    <li>Fully Automatic operation.</li>
                    <li>Built in drop-position to prevent failure and accidents.</li>
                    <li>Independent parking system.</li>
                    <li>Hydraulic based  or Traction Based systems.</li>
                    <li>Multi layer features - car dimension sensor (IR sensors).</li>
                    <li>PLC Integrated Control system.</li>
                    <li>Multi-layer cost effective parking system.</li>
                    </ul>
                    <div class="mt-5">
            ...
            <div class="col-lg-7">
                <div class="portfolio-content" data-lightbox="gallery">
                    <a title="" data-lightbox="gallery-image" href="images/portfolio/project/30.jpg">
                        <img src="{{asset('Asset/images/anzox/puzzle1.png')}}" data-animate="fadeInUp">
                    </a>
                    <br><br>
                    <a title="" data-lightbox="gallery-image" href="images/portfolio/project/41.jpg">
                        <img src="{{asset('Asset/images/anzox/parking-photos/Puzzle.jpeg')}}" data-animate="fadeInUp">
                    </a>
                    <br><br>
