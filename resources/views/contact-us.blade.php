...
@section('content')
    {{-- <section id="page-title" class="pb-5" data-bg-parallax="images/parallax/5.jpg">
    <div class="container">
        <div class="heading-text text-center heading-line">
            <h2 style="color:#c31e2f">Contact Us</h2>
        </div>

    </div>
</section>
<section style="background-color: #b41525" class="">

    <div class="">
        <div class="container-fluid text-center text-dark">
            <h1 style="font-family: 'Playball', cursive;">
...
<section class="background-dark text-white pt-0">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mt-5 pt-5">
                <div class="">
                    <h1>Get In Touch</h1>
                    <h2 class="line" style="border-top: 2px solid #c31e2f;"></h2>

                </div>

                <div class="mt-5">
                    <div class="">
                        <h4><i class="fa fa-phone m-4"></i> +91 70454 73377 <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; +91 97697 97973</h4>

                    </div>
                    <div class="">
                        <h4><i class="fa fa-envelope m-4"></i> connect@anzox.co.in</h4>

                    </div>
                    <div class="m-4">
                        <h4>
                            <a href="{{ asset('Asset/images/anzox/Brochure.pdf')}}" download target="_blank"
                                class="btn btn-danger"><i class="fa fa-download"></i> CATALOUGE </a>

                            <a class="btn btn-danger btn-lg" target="_blank"
                                href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=connect@anzox.co.in"
                                target="_blank"><i class="fa fa-envelope "></i> email Us</a>
                        </h4>

                    </div>
                    <div
                        class="col-m m-4 social-icons social-icons-medium social-icons-border social-icons-colored-hover">
                        <ul>
                            <li class="social-facebook mr-2"><a href="" target="_blank"><i class="fab fa-facebook-f"></i></a>
                            </li>
                            <li class="social-dribbble"><a href="" target="_blank"><i class="fab fa-instagram"></i></a>
                            </li>
                            <li class="social-linkedin"><a href="" target="_blank"><i class="fab fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-6 mt-5 pt-5 text-white">
                <div class="">
                    <h1>Address &amp; Map</h1>
                    <h2 class="line" style="border-top: 2px solid #c31e2f;"></h2>
                ...
                <div class="">
                    <address>
                        <strong>ANZOX </strong><br>
                        Shop No. 5, Kastur Mahal, Opp. Canara Bank, Sion, Mumbai - 400022.
                        <br>
                        </abbr></address>
                </div>
                <!-- Google Map -->
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d942.8548360974195!2d72.8650941!3d19.0452917!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x11e07e9164b8f1d!2sAnzox%20Engineering%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1662741243207!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    {{-- <section id="page-title" data-bg-parallax="images/parallax/5.jpg">
        <div class="parallax-container img-loaded" data-bg="images/parallax/5.jpg" data-velocity="-.140"
            style="background: url(&quot;images/parallax/5.jpg&quot;) 0% 0px;" data-ll-status="loaded"></div>
